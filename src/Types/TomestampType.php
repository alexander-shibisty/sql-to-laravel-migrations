...
use SqlParser\Types\Traits\{NullableTrait, IndexesTrait};

class TomestampType extends Type {
    use NullableTrait, IndexesTrait;
    ...
    public function __toString() {
        return addSpaces(4) . '$table->timestamp(\''.$this->field->name."')"
            .$this->getNullable()
